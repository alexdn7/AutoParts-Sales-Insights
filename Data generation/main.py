...
# Generate 100 users and save the data to a CSV file.
users = generate_user_data(100)
df_users = pd.DataFrame(users)
df_users.to_csv(r"Data generation/users.csv", index=False)

# Generate 100 auto parts and save the data to a CSV file.
parts = generate_autopart_data(100, r"Data generation/product_category.csv")
df_parts = pd.DataFrame(parts)
df_parts.to_csv(r"Data generation/autoparts.csv", index=False)

# Generate 100 orders and save the data to a CSV file.
...
orders = generate_order_data(100, users)
